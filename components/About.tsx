...
function About({pageInfo}: Props) {
  ...
  return (
    <div className='flex flex-col relative h-screen text-center md:text-left md:flex-row max-w-7xl px-5 md:px-20 justify-evenly mx-auto items-center'>
      <h3 className='section-title top-0 sm:top-16 md:top-20'> About</h3>
      ...
      <motion.div 
        ...
        viewport={{ once: true}}
        className='relative mt-16 flex-shrink-0 w-56 h-56 md:max-h-[50%] md:max-w-[40%] md:w-72 md:h-96 xl:w-[500px] xl:h-[600px]'>
        <Image 
      ...
      <div className='space-y-5 md:space-y-10 px-0 md:px-10 mt-0' >
